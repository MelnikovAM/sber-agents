...
# Fix Pydantic forward reference issues
from langchain_core.caches import BaseCache
from langchain_core.callbacks.base import Callbacks
from langchain_openai import ChatOpenAI, OpenAIEmbeddings

# Force rebuild with proper namespace
ChatOpenAI.model_rebuild(_types_namespace={"BaseCache": BaseCache, "Callbacks": Callbacks})
OpenAIEmbeddings.model_rebuild(_types_namespace={"BaseCache": BaseCache, "Callbacks": Callbacks})
...
def evaluate_dataset(dataset_name: Optional[str] = None) -> Dict[str, Any]:
    ...
    # langsmith.evaluate() возвращает ExperimentResults
    ...
    for idx, run_id in enumerate(run_ids):
        ...
        for metric in ragas_metrics:
            if metric.name in row:
                ...
                # Round to 4 decimal places (LangSmith API limit)
